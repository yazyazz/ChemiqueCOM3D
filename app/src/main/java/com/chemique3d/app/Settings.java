...
public class Settings extends AppCompatActivity implements
    ...
    public static class AccSettingsFragment extends PreferenceFragmentCompat {

        @Override
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            setPreferencesFromResource(R.xml.acc_settings_preferences, rootKey);
        }
    }
    ...
    public static class GraphicsFragment extends PreferenceFragmentCompat {

        @Override
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            setPreferencesFromResource(R.xml.graphics_preferences, rootKey);
        }
    }
    ...
    public static class SVFragment extends PreferenceFragmentCompat {

        @Override
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            setPreferencesFromResource(R.xml.sv_preferences, rootKey);
        }
    }
